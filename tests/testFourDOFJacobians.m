...
orig_4dof =         generateFourDOFMatrix(rx, ry, tx, ty);
rx_4dof_perturbed = generateFourDOFMatrix(rx+perturbation, ry, tx, ty);
ry_4dof_perturbed = generateFourDOFMatrix(rx, ry+perturbation, tx, ty);
tx_4dof_perturbed = generateFourDOFMatrix(rx, ry, tx+perturbation, ty);
ty_4dof_perturbed = generateFourDOFMatrix(rx, ry, tx, ty+perturbation);
